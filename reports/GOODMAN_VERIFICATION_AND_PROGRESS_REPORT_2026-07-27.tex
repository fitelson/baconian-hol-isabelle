...
most direct Cantorian objection to such an enumeration fails.
...
We recommend preserving two parallel lines of attack.
...
reduces the consistency problem to a
single explicit model-construction equation, but it does not yet answer the
question itself.}
