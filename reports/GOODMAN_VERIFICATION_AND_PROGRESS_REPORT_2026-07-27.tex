...
of this escape route but construction of an enlarged interpretation that
also validates \PP\ and the remaining background theory.
...
also completes the rebuilding step in M5, proves that the unrestricted
existential generalization of the M5 collision method is false, refutes L2 in
Bacon's appendix model and every relevant composition-closed enlargement,
and proves the exact T6 semantic consequence and several strengthening
results directly relevant to the notes.  The remaining underspecified and
model-dependent claims are explicitly identified.  Goodman's consistency
