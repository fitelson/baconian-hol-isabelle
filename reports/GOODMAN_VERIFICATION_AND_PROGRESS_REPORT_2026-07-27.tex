...
listed below together with purity of identity, negation, constant truth, and
constant falsity.  Consequently every subcollection of Goodman's principles
whose logical-purity instances are confined to those four formulas is
consistent in Bacon's proof system.  This does not settle the question,
because Goodman's intended theory makes every closed logical term pure at
every type.
...
The complete audit checks 96 principal results.  A fresh build passes.  None
of these proofs contains an admitted lemma, an untrusted proof step, or an
...
next planned extensions add purity of \(K\), then purity of conjunction; a
complete result requires all closed logical terms at all types.
...
and constant falsity.  The next extension should add purity of \(K\), then
purity of conjunction.
...
\item A model validating \PP\ when the logical-purity schema extends beyond
      identity, negation, constant truth, and constant falsity.  The next
      cases are \(K\) and conjunction; Goodman's full question requires all
...
\item \textbf{Continue adding logical purity.}  Identity, negation, constant
      truth, and constant falsity are now handled.  Add purity of \(K\), then
      purity of conjunction, while preserving closure of purity under
      application, Recombination, Exhaustion, Modalized Functionality, and
      \PP.  A complete result requires every closed logical term at every
      type.
...
truth, and constant falsity, so every subcollection whose logical-purity
instances are confined to those four formulas is consistent.  Goodman's
question remains open because the intended theory requires purity of every
