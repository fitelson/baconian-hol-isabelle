...
`pp_cone_determined` is the semantic surrogate for "definable from the
generators". That every term-definable function is cone-determined is the
object-language term induction, and is not formalized here; it is the same
standing gap as elsewhere in this development. Subject to it, this line of
argument is finished: persistence and attainment hold for seed-generated
domains, and the obstruction that looked like it might block the consistency
