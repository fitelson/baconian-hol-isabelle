theory Bacon_PP_ZF_Tree_Boolean_Probe_Background
  imports
    Higher_Order_Metaphysics_PP_ZF_Boolean_Probe_Model_Core.Bacon_PP_ZF_Tree_Boolean_Probe_Model_Core
begin

section \<open>PP in the stabilized Boolean model\<close>

lemma pp_t_probe_successor_model_target_PP_holds:
  "pp_t_holds
...
proof -
  have evaluation:
    ...
    unfolding pp_target_PP_def pp_purity_of_pure_def
      pp_pure_def
    by (simp add: pp_t_probe_successor_classifier_def)
  have at_classifier:
      "pp_t_holds
        (pp_t_classifier pp_t_boolean_probe_classifier_type
          (pp_t_probe_successor_model_pure
            pp_t_boolean_probe_classifier_type)
          \<acute> pp_t_probe_successor_classifier) w
      \<longleftrightarrow>
      pp_t_probe_successor_model_pure
  ...
  show ?thesis
    ...
    using at_classifier
      pp_t_probe_successor_model_classifier_is_pure
    by blast
qed

theorem pp_t_probe_successor_model_target_PP_gvalid:
  "ProbeSuccessorModelConstants.TreeHenkin.gvalid \<Gamma>
    pp_target_PP"
  unfolding ProbeSuccessorModelConstants.TreeHenkin.gvalid_def
    ProbeSuccessorModelConstants.pp_t_den_def
  using pp_t_probe_successor_model_target_PP_holds by blast

section \<open>Unique fundamentality\<close>

lemma pp_t_probe_successor_model_unique_fundamental_holds:
  "pp_t_holds
    (pp_t_eval pp_t_probe_successor_model_constants \<rho>
      (pp_unique_fundamental Prop)) w"
proof -
  let ?r = "pp_t_probe_successor_stock_seed_at w"
  have base: "pp_t_env_typed [] \<rho>"
    by (rule pp_t_empty_env_typed)
  have r_env:
      "pp_t_env_typed [Prop] (extend_env ?r \<rho>)"
    using pp_t_env_typed_extend[
      OF base pp_t_probe_successor_stock_seed_at_in_domain] .
  have r_is_fundamental:
      "pp_t_holds
        (pp_t_eval pp_t_probe_successor_model_constants
  ...
  proof -
    ...
    have rr: "pp_t_eqv Prop w ?r ?r"
      by (rule pp_t_eqv_reflexive[
        OF pp_t_probe_successor_stock_seed_at_in_domain])
    show ?thesis
      using pp_t_probe_successor_model_eval_fun_holds[
  ...
  show ?thesis
    ...
    using pp_t_probe_successor_stock_seed_at_in_domain
      r_is_fundamental uniqueness
    by (simp only: pp_t_eval_Conj_holds
        pp_t_eval_Forall_holds)
qed

theorem pp_t_probe_successor_model_unique_fundamental_gvalid:
  "ProbeSuccessorModelConstants.TreeHenkin.gvalid \<Gamma>
    (pp_unique_fundamental Prop)"
  unfolding ProbeSuccessorModelConstants.TreeHenkin.gvalid_def
    ProbeSuccessorModelConstants.pp_t_den_def
  using pp_t_probe_successor_model_unique_fundamental_holds
  by blast

section \<open>Recombination\<close>

lemma pp_t_probe_successor_model_zeroary_recombination_holds:
  "pp_t_holds
    (pp_t_eval pp_t_probe_successor_model_constants \<rho>
...
theorem pp_t_probe_successor_model_zeroary_recombination_gvalid:
  "ProbeSuccessorModelConstants.TreeHenkin.gvalid \<Gamma>
    pp_zeroary_recombination"
  unfolding ProbeSuccessorModelConstants.TreeHenkin.gvalid_def
    ProbeSuccessorModelConstants.pp_t_den_def
  using pp_t_probe_successor_model_zeroary_recombination_holds
  by blast

lemma pp_t_probe_successor_model_unary_recombination_holds_iff:
  "pp_t_holds
      (pp_t_eval pp_t_probe_successor_model_constants \<rho>
      ...
      (\<forall>r. Elem r (pp_t_domain Prop) \<longrightarrow>
        (pp_t_probe_successor_model_pure
          ...
          \<and> pp_t_seeded_fundamental_at
            pp_t_probe_successor_stock_seed_at Prop w r)
        \<longrightarrow>
...
lemma pp_t_probe_successor_model_fundamental_recombines:
  assumes X:
      "Elem X (pp_t_domain pp_t_boolean_probe_unary_type)"
    and X_pure:
      "pp_t_probe_successor_model_pure
  ...
  shows "\<forall>q. Elem q (pp_t_domain Prop) \<longrightarrow>
    pp_t_holds (X \<acute> q) w"
proof -
  let ?seed = "pp_t_probe_successor_stock_seed_at w"
  ...
  proof (intro allI impI)
    ...
    show "pp_t_holds (X \<acute> ?seed) v"
      ...
      by simp
  qed
  have X_stock: "pp_t_probe_successor_stock w X"
...
lemma pp_t_probe_successor_model_unary_recombination_holds:
  "pp_t_holds
    (pp_t_eval pp_t_probe_successor_model_constants \<rho>
      pp_unary_recombination) w"
  unfolding
    pp_t_probe_successor_model_unary_recombination_holds_iff
  using pp_t_probe_successor_model_fundamental_recombines
  by blast

theorem pp_t_probe_successor_model_unary_recombination_gvalid:
  "ProbeSuccessorModelConstants.TreeHenkin.gvalid \<Gamma>
    pp_unary_recombination"
  unfolding ProbeSuccessorModelConstants.TreeHenkin.gvalid_def
    ProbeSuccessorModelConstants.pp_t_den_def
  using pp_t_probe_successor_model_unary_recombination_holds
  by blast
