theory Bacon_PP_ZF_Fresh_Necessity_Fragment_Model
  imports
    "Higher_Order_Metaphysics_PP_ZF_Truth_Functions.Bacon_PP_ZF_Fresh_Binary_Truth_Functions_Fragment_Model"
begin

section \<open>The necessity operator\<close>

definition pp_t_necessity_operator :: ZF where
  "pp_t_necessity_operator =
    pp_t_classifier Prop
      (\<lambda>w p. pp_t_eqv Prop w p (pp_zf_truth True))"

lemma pp_t_necessity_operator_in_domain:
  "Elem pp_t_necessity_operator
    (pp_t_domain pp_t_constants_unary_type)"
  unfolding pp_t_necessity_operator_def
  by (rule pp_t_classifier_in_domain)
    (rule pp_t_identity_predicate_admissible[
      OF pp_t_truth_in_domain])

lemma pp_t_necessity_operator_holds:
  assumes p: "Elem p (pp_t_domain Prop)"
  shows "pp_t_holds (pp_t_necessity_operator \<acute> p) w
    \<longleftrightarrow>
  ...
  using pp_t_classifier_holds[
    OF p,
    of "\<lambda>w p.
      pp_t_eqv Prop w p (pp_zf_truth True)" w]
  by simp

lemma pp_t_eval_eq_truth_logical_operator:
  "pp_t_eval C \<rho> pp_zf_eq_truth_operator =
    pp_t_necessity_operator"
  unfolding pp_zf_eq_truth_operator_def
    pp_t_necessity_operator_def pp_t_classifier_def
...
lemma pp_t_truth_eqv_truth_iff:
  "pp_t_eqv Prop w (pp_zf_truth a) (pp_zf_truth b)
    \<longleftrightarrow> a = b"
  by (cases a; cases b; auto)

lemma pp_t_necessity_truth_eqv:
  "pp_t_eqv Prop w
    (pp_t_necessity_operator \<acute> pp_zf_truth b)
    (pp_zf_truth b)"
  unfolding pp_t_eqv.simps
  using pp_t_necessity_operator_holds[
    OF pp_t_truth_in_domain, of b]
  by (cases b)
    (auto simp: pp_t_truth_eqv_truth_iff)

section \<open>The necessity-closed pure stock\<close>

definition pp_t_necessity_unary_pure ::
    "bool list \<Rightarrow> ZF \<Rightarrow> bool"
where
  "pp_t_necessity_unary_pure w x \<longleftrightarrow>
...
lemma pp_t_necessity_unary_pure_admissible:
  "pp_t_predicate_admissible pp_t_constants_unary_type
    pp_t_necessity_unary_pure"
proof -
  have old:
      "pp_t_predicate_admissible pp_t_constants_unary_type
        (pp_t_binary_truth_fragment_pure
          pp_t_constants_unary_type)"
    by (rule pp_t_binary_truth_fragment_pure_admissible)
  have necessity:
      "pp_t_predicate_admissible pp_t_constants_unary_type
  ...
  show ?thesis
    ...
    unfolding pp_t_predicate_admissible_def
      pp_t_necessity_unary_pure_def
    by blast
qed

definition pp_t_necessity_stock_classifier :: ZF where
  "pp_t_necessity_stock_classifier =
    pp_t_classifier pp_t_constants_unary_type
      pp_t_necessity_unary_pure"

lemma pp_t_necessity_stock_classifier_in_domain:
  "Elem pp_t_necessity_stock_classifier
    (pp_t_domain pp_t_constants_classifier_type)"
  unfolding pp_t_necessity_stock_classifier_def
  by (rule pp_t_classifier_in_domain)
    (rule pp_t_necessity_unary_pure_admissible)

definition pp_t_necessity_fragment_pure ::
    "otype \<Rightarrow> bool list \<Rightarrow> ZF \<Rightarrow> bool"
where
  "pp_t_necessity_fragment_pure \<sigma> w x \<longleftrightarrow>
    ...
    (\<sigma> = pp_t_constants_classifier_type
      \<and> pp_t_eqv pp_t_constants_classifier_type
        w pp_t_necessity_stock_classifier x)"

lemma pp_t_necessity_fragment_pure_admissible:
...
proof -
  ...
  have classifier:
      "pp_t_predicate_admissible pp_t_constants_classifier_type
        (\<lambda>w x. pp_t_eqv pp_t_constants_classifier_type
          w pp_t_necessity_stock_classifier x)"
    using pp_t_eqv_classifier_admissible[
      OF pp_t_necessity_stock_classifier_in_domain] .
  show ?thesis
    unfolding pp_t_predicate_admissible_def
  proof (intro allI impI)
    ...
    have old_iff:
        "pp_t_binary_truth_fragment_pure \<sigma> v x
          \<longleftrightarrow>
         pp_t_binary_truth_fragment_pure \<sigma> v y"
      using old x y xy future
      unfolding pp_t_predicate_admissible_def by blast
    have necessity_iff:
        "\<sigma> = pp_t_constants_unary_type \<Longrightarrow>
        pp_t_eqv pp_t_constants_unary_type
            v pp_t_necessity_operator x
          \<longleftrightarrow>
        pp_t_eqv pp_t_constants_unary_type
            v pp_t_necessity_operator y"
      using necessity x y xy future
      unfolding pp_t_predicate_admissible_def by blast
    have classifier_iff:
        "\<sigma> = pp_t_constants_classifier_type \<Longrightarrow>
        pp_t_eqv pp_t_constants_classifier_type
            v pp_t_necessity_stock_classifier x
          \<longleftrightarrow>
        pp_t_eqv pp_t_constants_classifier_type
            v pp_t_necessity_stock_classifier y"
      using classifier x y xy future
      unfolding pp_t_predicate_admissible_def by blast
    show "pp_t_necessity_fragment_pure \<sigma> v x =
        pp_t_necessity_fragment_pure \<sigma> v y"
      unfolding pp_t_necessity_fragment_pure_def
      using old_iff necessity_iff classifier_iff by blast
  qed
qed

lemma pp_t_necessity_inherits_old_pure:
  assumes old: "pp_t_binary_truth_fragment_pure \<sigma> w x"
    and not_classifier:
...
lemma pp_t_necessity_operator_is_pure[simp]:
...
lemma pp_t_necessity_classifier_is_pure[simp]:
  "pp_t_necessity_fragment_pure
...
lemma pp_t_necessity_pure_Prop_iff:
  "pp_t_necessity_fragment_pure Prop w P
    \<longleftrightarrow>
    pp_t_binary_truth_fragment_pure Prop w P"
  unfolding pp_t_necessity_fragment_pure_def by simp

lemma pp_t_necessity_pure_unary_iff:
  "pp_t_necessity_fragment_pure
      pp_t_constants_unary_type w X
    \<longleftrightarrow>
    pp_t_necessity_unary_pure w X"
  unfolding pp_t_necessity_fragment_pure_def
    pp_t_necessity_unary_pure_def
  by simp

lemma pp_t_necessity_pure_classifier_iff:
  "pp_t_necessity_fragment_pure
...
lemma pp_t_binary_truth_pure_function_from_unary:
  assumes pure:
      "pp_t_binary_truth_fragment_pure
...
lemma pp_t_binary_truth_no_pure_function_from_classifier:
  "\<not> pp_t_binary_truth_fragment_pure
...
lemma pp_t_necessity_old_input:
  assumes pure_f:
      "pp_t_binary_truth_fragment_pure
...
proof -
  from pure_x consider
      (old) "pp_t_binary_truth_fragment_pure \<sigma> w x"
    | (necessity)
        "\<sigma> = pp_t_constants_unary_type"
        "pp_t_eqv pp_t_constants_unary_type
          w pp_t_necessity_operator x"
  ...
  next
    ...
    have pure_unary:
        "pp_t_binary_truth_fragment_pure
          (pp_t_constants_unary_type \<rightarrow>\<^sub>o \<tau>) w f"
      using pure_f necessity by simp
    have tau: "\<tau> = Prop"
      using pp_t_binary_truth_pure_function_from_unary[
        OF pure_unary] .
    have False
      using retained necessity tau by simp
    then show ?thesis by blast
  next
    case classifier
    have False
      using pp_t_binary_truth_no_pure_function_from_classifier[
...
lemma pp_t_necessity_application:
  assumes f:
      "Elem f (pp_t_domain pp_t_constants_unary_type)"
    and x: "Elem x (pp_t_domain Prop)"
    and representative:
      "pp_t_eqv pp_t_constants_unary_type
        w pp_t_necessity_operator f"
    and pure_x:
      "pp_t_necessity_fragment_pure Prop w x"
  shows "pp_t_necessity_fragment_pure Prop w (f \<acute> x)"
proof -
  have x_class:
      "pp_t_eqv Prop w (pp_zf_truth True) x
        \<or> pp_t_eqv Prop w (pp_zf_truth False) x"
    using pure_x
    unfolding pp_t_necessity_pure_Prop_iff
  ...
  have result:
    ...
    using pp_t_necessity_truth_eqv[
        of w b]
      pp_t_app_closed[
        OF pp_t_necessity_operator_in_domain
...
lemma pp_t_necessity_unary_pure_persistent:
  assumes pure: "pp_t_necessity_unary_pure w x"
    and future: "prefix w v"
  shows "pp_t_necessity_unary_pure v x"
  using pure pp_t_eqv_persistent[OF _ future]
  unfolding pp_t_necessity_unary_pure_def
...
lemma pp_t_necessity_stock_classifier_on_pure:
  assumes x:
      "Elem x (pp_t_domain pp_t_constants_unary_type)"
    and pure: "pp_t_necessity_unary_pure w x"
  shows "pp_t_eqv Prop w
    (pp_t_necessity_stock_classifier \<acute> x)
    (pp_zf_truth True)"
proof -
  have pure_future:
      "\<forall>v. prefix w v \<longrightarrow>
        pp_t_necessity_unary_pure v x"
    using pp_t_necessity_unary_pure_persistent[
      OF pure] by blast
  show ?thesis
    unfolding pp_t_prop_eqv_truth_iff
      pp_t_necessity_stock_classifier_def
    using pp_t_classifier_holds[
      OF x, of pp_t_necessity_unary_pure]
      pure_future
    by simp
qed

lemma pp_t_necessity_classifier_application:
  assumes f:
    ...
    and representative:
      "pp_t_eqv pp_t_constants_classifier_type
        w pp_t_necessity_stock_classifier f"
    and pure_x: "pp_t_necessity_unary_pure w x"
  shows "pp_t_necessity_fragment_pure Prop w (f \<acute> x)"
proof -
  have xx:
  ...
  have result:
    ...
    using pp_t_necessity_stock_classifier_on_pure[
        OF x pure_x]
      applications pp_t_truth_in_domain
      pp_t_app_closed[
        OF pp_t_necessity_stock_classifier_in_domain x]
      pp_t_app_closed[OF f x]
    by (meson pp_t_eqv_symmetric pp_t_eqv_transitive)
  show ?thesis
    unfolding pp_t_necessity_pure_Prop_iff
...
lemma pp_t_necessity_fragment_application:
  assumes f:
    ...
    and pure_x:
      "pp_t_necessity_fragment_pure \<sigma> w x"
  shows "pp_t_necessity_fragment_pure \<tau> w (f \<acute> x)"
proof -
  ...
  proof cases
    ...
    have old_x:
        "pp_t_binary_truth_fragment_pure \<sigma> w x"
      by (rule pp_t_necessity_old_input[
        OF old pure_x])
    have old_result:
        "pp_t_binary_truth_fragment_pure \<tau> w (f \<acute> x)"
      by (rule pp_t_binary_truth_fragment_application[
        OF f x old(1) old_x])
    have not_classifier:
  ...
  next
    case necessity
    show ?thesis
      using pp_t_necessity_application[
        OF _ _ necessity(3)] f x pure_x necessity
      by simp
  next
    case classifier
    ...
    have unary_pure:
        "pp_t_necessity_unary_pure w x"
      using pp_t_necessity_pure_unary_iff[
        of w x] pure_unary_fragment
      by blast
    show ?thesis
      using pp_t_necessity_classifier_application[
...
interpretation NecessityFragment:
  pp_t_moving_internal_parameters
    pp_t_necessity_fragment_pure
  by standard
    (rule pp_t_necessity_fragment_pure_admissible)

abbreviation pp_t_necessity_fragment_constants ::
    "string \<Rightarrow> otype \<Rightarrow> ZF"
where
  "pp_t_necessity_fragment_constants \<equiv>
    pp_t_moving_internal_constants
      pp_t_necessity_fragment_pure"

lemma pp_t_necessity_old_purity_holds:
  assumes typed: "[] \<turnstile> M : \<sigma>"
    and representative: "Elem a (pp_t_domain \<sigma>)"
    and related:
      "pp_t_eqv \<sigma> w a
        (pp_t_eval pp_t_necessity_fragment_constants \<rho> M)"
    and old_pure:
      "pp_t_binary_truth_fragment_pure \<sigma> w a"
    and not_classifier:
      "\<sigma> \<noteq> pp_t_constants_classifier_type"
  shows "pp_t_holds
    (pp_t_eval pp_t_necessity_fragment_constants \<rho>
      (pp_pure \<sigma> M)) w"
proof -
  ...
  have evaluated:
      "Elem
        ...
        (pp_t_domain \<sigma>)"
    using
      NecessityFragment.MovingTreeConstants.pp_t_eval_type[
        OF typed env]
  ...
  have same_purity:
      "pp_t_necessity_fragment_pure \<sigma> w a
        \<longleftrightarrow>
       pp_t_necessity_fragment_pure \<sigma> w
        (pp_t_eval pp_t_necessity_fragment_constants \<rho> M)"
    using pp_t_necessity_fragment_pure_admissible
  ...
  show ?thesis
    using
      NecessityFragment.pp_t_moving_eval_pure_holds[
        OF typed env, of w]
      pure_evaluated
    by simp
qed

lemma pp_t_necessity_truth_function_purity_holds:
  "pp_t_holds
    (pp_t_eval pp_t_necessity_fragment_constants \<rho>
...
proof -
  ...
  have related:
    ...
    by (rule pp_t_eval_truth_function_builder_eqv[
      OF NecessityFragment.MovingTreeConstants.C_typed env])
  show ?thesis
    by (rule pp_t_necessity_old_purity_holds[
      OF typed representative
        related pp_t_truth_function_is_pure])
      simp
qed

theorem pp_t_necessity_truth_function_purity_gvalid:
  "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid \<Gamma>
    (pp_pure pp_t_binary_truth_builder_type
      (pp_truth_function_builder F))"
  unfolding
    NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid_def
    NecessityFragment.MovingTreeConstants.pp_t_den_def
  using pp_t_necessity_truth_function_purity_holds by blast

lemma pp_t_necessity_conjunction_purity_holds:
  "pp_t_holds
    (pp_t_eval pp_t_necessity_fragment_constants \<rho>
      (pp_pure pp_t_binary_truth_builder_type
...
proof -
  ...
  show ?thesis
    by (rule pp_t_necessity_old_purity_holds[
      OF typed pp_t_conjunction_builder_in_domain
        related old_pure])
      simp
qed

theorem pp_t_necessity_conjunction_purity_gvalid:
  "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid \<Gamma>
    (pp_pure pp_t_binary_truth_builder_type
      pp_conjunction_builder)"
  unfolding
    NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid_def
    NecessityFragment.MovingTreeConstants.pp_t_den_def
  using pp_t_necessity_conjunction_purity_holds by blast

lemma pp_t_necessity_constant_builder_purity_holds:
  "pp_t_holds
    (pp_t_eval pp_t_necessity_fragment_constants \<rho>
      (pp_pure pp_t_binary_truth_builder_type
...
proof -
  ...
  have related:
    ...
    by (rule pp_t_eqv_reflexive[
      OF pp_t_constant_builder_in_domain])
  show ?thesis
    by (rule pp_t_necessity_old_purity_holds[
      OF typed pp_t_constant_builder_in_domain
        related old_pure])
      simp
qed

theorem pp_t_necessity_constant_builder_purity_gvalid:
  "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid \<Gamma>
    (pp_pure pp_t_binary_truth_builder_type
      pp_constant_builder)"
  unfolding
    NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid_def
    NecessityFragment.MovingTreeConstants.pp_t_den_def
  using pp_t_necessity_constant_builder_purity_holds by blast

lemma pp_t_necessity_identity_purity_holds:
  "pp_t_holds
    (pp_t_eval pp_t_necessity_fragment_constants \<rho>
...
proof -
  ...
  show ?thesis
    by (rule pp_t_necessity_old_purity_holds[
      OF typed_prop_id pp_t_identity_operator_in_domain
        related old_pure])
      simp
qed

theorem pp_t_necessity_identity_purity_gvalid:
  "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid \<Gamma>
    (pp_pure pp_t_constants_unary_type prop_id)"
  unfolding
    NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid_def
    NecessityFragment.MovingTreeConstants.pp_t_den_def
  using pp_t_necessity_identity_purity_holds by blast

lemma pp_t_necessity_negation_purity_holds:
  "pp_t_holds
    (pp_t_eval pp_t_necessity_fragment_constants \<rho>
...
proof -
  ...
  show ?thesis
    by (rule pp_t_necessity_old_purity_holds[
      OF typed pp_t_negation_operator_in_domain
        related old_pure])
      simp
qed

theorem pp_t_necessity_negation_purity_gvalid:
  "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid \<Gamma>
    (pp_pure pp_t_constants_unary_type
      pp_negation_operator)"
  unfolding
    NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid_def
    NecessityFragment.MovingTreeConstants.pp_t_den_def
  using pp_t_necessity_negation_purity_holds by blast

lemma pp_t_necessity_constant_purity_holds:
  "pp_t_holds
    (pp_t_eval pp_t_necessity_fragment_constants \<rho>
      (pp_pure pp_t_constants_unary_type
        (pp_constant_operator (if b then ObjTrue else ObjFalse)))) w"
proof -
  have object_typed:
      "[] \<turnstile>
...
theorem pp_t_necessity_constant_truth_purity_gvalid:
  "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid \<Gamma>
    (pp_pure pp_t_constants_unary_type
...
proof -
  have holds:
    ...
    using pp_t_necessity_constant_purity_holds[
...
theorem pp_t_necessity_constant_falsity_purity_gvalid:
  "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid \<Gamma>
    (pp_pure pp_t_constants_unary_type
...
lemma pp_t_necessity_operator_purity_holds:
  "pp_t_holds
    (pp_t_eval pp_t_necessity_fragment_constants \<rho>
      (pp_pure pp_t_constants_unary_type
...
proof -
  ...
  show ?thesis
    using
      NecessityFragment.pp_t_moving_eval_pure_holds[
        OF pp_zf_eq_truth_operator_typed env, of w]
      pp_t_necessity_operator_is_pure
    by (simp add: pp_t_eval_eq_truth_logical_operator)
qed

theorem pp_t_necessity_operator_purity_gvalid:
  "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid \<Gamma>
    (pp_pure pp_t_constants_unary_type
  ...
  unfolding
    NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid_def
    NecessityFragment.MovingTreeConstants.pp_t_den_def
  using pp_t_necessity_operator_purity_holds by blast

section \<open>PP, application closure, and fundamentality\<close>

lemma pp_t_necessity_target_PP_holds:
  "pp_t_holds
    (pp_t_eval pp_t_necessity_fragment_constants \<rho>
      pp_target_PP) w"
proof -
  have unary_classifier:
    ...
    unfolding pp_t_necessity_stock_classifier_def
      pp_t_classifier_def
    by (simp add: pp_t_necessity_pure_unary_iff)
  show ?thesis
    unfolding pp_target_PP_def pp_purity_of_pure_def
      pp_pure_def
    using pp_t_classifier_holds[
      OF pp_t_necessity_stock_classifier_in_domain,
      of "pp_t_necessity_fragment_pure
        pp_t_constants_classifier_type" w]
      pp_t_necessity_classifier_is_pure
    by (simp add: unary_classifier)
qed

theorem pp_t_necessity_target_PP_gvalid:
  "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid \<Gamma>
    pp_target_PP"
  unfolding
    NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid_def
    NecessityFragment.MovingTreeConstants.pp_t_den_def
  using pp_t_necessity_target_PP_holds by blast

lemma pp_t_necessity_application_closure_holds_iff:
  "pp_t_holds
      (pp_t_eval pp_t_necessity_fragment_constants \<rho>
    ...
    (\<forall>f.
      ...
      (\<forall>x. Elem x (pp_t_domain \<sigma>) \<longrightarrow>
        pp_t_necessity_fragment_pure
          (\<sigma> \<rightarrow>\<^sub>o \<tau>) w f
        \<and> pp_t_necessity_fragment_pure \<sigma> w x
        \<longrightarrow>
...
theorem pp_t_necessity_application_closure_gvalid:
  "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid \<Gamma>
    (pp_application_closure \<sigma> \<tau>)"
proof (rule
    NecessityFragment.MovingTreeConstants.TreeHenkin.gvalidI)
  fix env w
  assume "env_ok (map pp_t_dom \<Gamma>) env"
  show "pp_t_holds
      (NecessityFragment.MovingTreeConstants.pp_t_den
        (pp_application_closure \<sigma> \<tau>) env) w"
    unfolding
      NecessityFragment.MovingTreeConstants.pp_t_den_def
      pp_t_necessity_application_closure_holds_iff
    using pp_t_necessity_fragment_application by blast
qed

theorem pp_t_necessity_unique_fundamental_gvalid:
  "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid \<Gamma>
  ...
  unfolding
    ...
    NecessityFragment.MovingTreeConstants.pp_t_den_def
  using
    NecessityFragment.pp_t_moving_unique_fundamental_holds
  by blast

theorem pp_t_necessity_no_fundamentals_gvalid:
  ...
  unfolding
    ...
    NecessityFragment.MovingTreeConstants.pp_t_den_def
  using
    NecessityFragment.pp_t_moving_no_fundamentals_holds[
      OF assms]
  by blast

section \<open>Recombination, Exhaustion, and functionality\<close>

lemma pp_t_necessity_zeroary_recombination_holds:
  "pp_t_holds
    (pp_t_eval pp_t_necessity_fragment_constants \<rho>
...
proof -
  ...
  proof -
    ...
    have pure_iff:
        "pp_t_holds
          (pp_t_eval pp_t_necessity_fragment_constants
...
lemma pp_t_necessity_zeroary_exhaustion_holds:
  "pp_t_holds
    (pp_t_eval pp_t_necessity_fragment_constants \<rho>
...
theorem pp_t_necessity_zeroary_recombination_gvalid:
  "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid \<Gamma>
    pp_zeroary_recombination"
  unfolding
    NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid_def
    NecessityFragment.MovingTreeConstants.pp_t_den_def
  using pp_t_necessity_zeroary_recombination_holds by blast

theorem pp_t_necessity_zeroary_exhaustion_gvalid:
  "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid \<Gamma>
    pp_zeroary_exhaustion"
  unfolding
    NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid_def
    NecessityFragment.MovingTreeConstants.pp_t_den_def
  using pp_t_necessity_zeroary_exhaustion_holds by blast

lemma pp_t_necessity_class_QLN:
  assumes X:
      "Elem X (pp_t_domain pp_t_constants_unary_type)"
...
proof -
  ...
  have applications:
      "pp_t_eqv Prop w
        (pp_t_necessity_operator \<acute> r) (X \<acute> r)"
    by (rule pp_t_app_respects[
  ...
  proof
    ...
    have seed_true:
      ...
      using fundamental r pp_t_moving_seed_in_domain
        pp_t_truth_in_domain r_true
      by (simp add: pp_t_eqv_symmetric
        pp_t_eqv_transitive)
    show False
      using pp_t_moving_seed_false_now seed_true by blast
  qed
  have necessity_r_false:
      "\<not> pp_t_holds (pp_t_necessity_operator \<acute> r) w"
    using pp_t_necessity_operator_holds[OF r, of w]
      r_not_true by blast
  have Xr_false: "\<not> pp_t_holds (X \<acute> r) w"
  proof
    assume Xr: "pp_t_holds (X \<acute> r) w"
    have at_w:
        "pp_t_holds (pp_t_necessity_operator \<acute> r) w
          \<longleftrightarrow> pp_t_holds (X \<acute> r) w"
      using pp_t_prop_eqv_at[OF applications, of w]
      by simp
    show False using necessity_r_false Xr at_w by blast
  qed
  have not_necessary:
  ...
  have necessity_false:
      "\<not> pp_t_holds
        (pp_t_necessity_operator \<acute> pp_zf_truth False) w"
    using pp_t_necessity_operator_holds[
        OF false_domain, of w]
      pp_t_truth_eqv_truth_iff[
        of w False True]
    by simp
  have X_false:
  ...
  proof
    ...
    have at_w:
      ...
      by simp
    show False using necessity_false Xf at_w by blast
  qed
  have not_universal:
...
lemma pp_t_necessity_pure_unary_QLN:
  assumes X:
      "Elem X (pp_t_domain pp_t_constants_unary_type)"
    and r: "Elem r (pp_t_domain Prop)"
    and pure:
  ...
  proof
    ...
    have constants_pure:
        "pp_t_constants_fragment_pure
          pp_t_constants_unary_type w X"
      using old
      unfolding pp_t_binary_truth_pure_unary_iff
    ...
    show
      "((\<forall>v. prefix w v \<longrightarrow>
        ...
        (\<forall>q. Elem q (pp_t_domain Prop) \<longrightarrow>
          pp_t_holds (X \<acute> q) w))"
      by (rule pp_t_constants_pure_unary_QLN(1)[
        OF X r constants_pure fundamental])
  next
    assume necessity:
        "pp_t_eqv pp_t_constants_unary_type
          w pp_t_necessity_operator X"
    show
      "((\<forall>v. prefix w v \<longrightarrow>
        ...
        (\<forall>q. Elem q (pp_t_domain Prop) \<longrightarrow>
          pp_t_holds (X \<acute> q) w))"
      by (rule pp_t_necessity_class_QLN(1)[
        OF X r necessity fundamental])
  qed
  from classes show
      "((\<forall>q. Elem q (pp_t_domain Prop) \<longrightarrow>
          pp_t_holds (X \<acute> q) w)
  ...
  proof
    ...
    show
      "((\<forall>q. Elem q (pp_t_domain Prop) \<longrightarrow>
        ...
        (\<forall>v. prefix w v \<longrightarrow>
          pp_t_holds (X \<acute> r) v))"
      by (rule pp_t_constants_pure_unary_QLN(2)[
        OF X r constants_pure fundamental])
  next
    assume necessity:
        "pp_t_eqv pp_t_constants_unary_type
    ...
    show
      "((\<forall>q. Elem q (pp_t_domain Prop) \<longrightarrow>
        ...
        (\<forall>v. prefix w v \<longrightarrow>
          pp_t_holds (X \<acute> r) v))"
      by (rule pp_t_necessity_class_QLN(2)[
        OF X r necessity fundamental])
  qed
qed

lemma pp_t_necessity_unary_recombination_holds_iff:
  "pp_t_holds
      (pp_t_eval pp_t_necessity_fragment_constants \<rho>
...
lemma pp_t_necessity_unary_exhaustion_holds_iff:
  "pp_t_holds
      (pp_t_eval pp_t_necessity_fragment_constants \<rho>
...
theorem pp_t_necessity_unary_recombination_holds:
  "pp_t_holds
    (pp_t_eval pp_t_necessity_fragment_constants \<rho>
      pp_unary_recombination) w"
  unfolding pp_t_necessity_unary_recombination_holds_iff
  using pp_t_necessity_pure_unary_QLN(1)
  by blast

theorem pp_t_necessity_unary_exhaustion_holds:
  "pp_t_holds
    (pp_t_eval pp_t_necessity_fragment_constants \<rho>
      pp_unary_exhaustion) w"
  unfolding pp_t_necessity_unary_exhaustion_holds_iff
  using pp_t_necessity_pure_unary_QLN(2)
  by blast

theorem pp_t_necessity_unary_recombination_gvalid:
  "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid \<Gamma>
    pp_unary_recombination"
  unfolding
    NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid_def
    NecessityFragment.MovingTreeConstants.pp_t_den_def
  using pp_t_necessity_unary_recombination_holds by blast

theorem pp_t_necessity_unary_exhaustion_gvalid:
  "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid \<Gamma>
    pp_unary_exhaustion"
  unfolding
    NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid_def
    NecessityFragment.MovingTreeConstants.pp_t_den_def
  using pp_t_necessity_unary_exhaustion_holds by blast

lemma pp_t_necessity_modalized_functionality_holds_iff:
  "pp_t_holds
      (pp_t_eval pp_t_necessity_fragment_constants \<rho>
...
theorem pp_t_necessity_modalized_functionality_gvalid:
  "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid \<Gamma>
...
proof (rule
  ...
  show "pp_t_holds
    ...
    unfolding
      NecessityFragment.MovingTreeConstants.pp_t_den_def
      pp_t_necessity_modalized_functionality_holds_iff
    using pp_t_arrow_eqv_if_pointwise by blast
qed

section \<open>The necessity fragment\<close>

definition pp_necessity_purity_axiom :: oterm where
  "pp_necessity_purity_axiom =
    pp_pure pp_unary_ty pp_zf_eq_truth_operator"

lemma pp_necessity_purity_axiom_in_schema:
  "pp_necessity_purity_axiom \<in> pp_purity_schema"
  unfolding pp_necessity_purity_axiom_def
    pp_purity_schema_def
proof (intro CollectI exI conjI)
  show "[] \<turnstile> pp_zf_eq_truth_operator :
      pp_unary_ty"
    using pp_zf_eq_truth_operator_typed
    unfolding pp_unary_ty_def .
  show "pp_logical_vocabulary pp_zf_eq_truth_operator"
    by (rule pp_zf_eq_truth_operator_logical)
  show "pp_pure pp_unary_ty pp_zf_eq_truth_operator =
      pp_pure pp_unary_ty pp_zf_eq_truth_operator"
    by simp
qed

definition pp_necessity_fragment_PP_axioms ::
    "oterm set"
where
...
theorem pp_t_necessity_binary_axioms_gvalid:
  "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid_set
    pp_binary_truth_fragment_PP_axioms"
  unfolding
    NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid_set_def
proof (intro allI impI)
  fix \<Gamma> A
  ...
  from A consider
    ...
    by blast
  then show
      "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid
        \<Gamma> A"
  proof cases
    case truth_function
    then show ?thesis
      using pp_t_necessity_truth_function_purity_gvalid
      unfolding pp_unary_ty_def by simp
  next
    case builder
    then show ?thesis
      using pp_t_necessity_conjunction_purity_gvalid
      unfolding pp_unary_ty_def by simp
  next
    case constant_builder
    then show ?thesis
      using pp_t_necessity_constant_builder_purity_gvalid
      unfolding pp_unary_ty_def by simp
  next
    case constant_truth
    then show ?thesis
      using pp_t_necessity_constant_truth_purity_gvalid
      unfolding pp_unary_ty_def by simp
  next
    case constant_falsity
    then show ?thesis
      using pp_t_necessity_constant_falsity_purity_gvalid
      unfolding pp_unary_ty_def by simp
  next
    case identity_purity
    then show ?thesis
      using pp_t_necessity_identity_purity_gvalid by simp
  next
    case negation_purity
    then show ?thesis
      using pp_t_necessity_negation_purity_gvalid by simp
  next
    case target
    then show ?thesis
      using pp_t_necessity_target_PP_gvalid by simp
  next
    case application
    ...
    show ?thesis
      unfolding A
      by (rule pp_t_necessity_application_closure_gvalid)
  next
    case unique
    then show ?thesis
      using pp_t_necessity_unique_fundamental_gvalid by simp
  next
    case no_other
    ...
    show ?thesis
      unfolding A
      by (rule pp_t_necessity_no_fundamentals_gvalid[
        OF nonprop])
  next
    case zeroary_recombination
    then show ?thesis
      using pp_t_necessity_zeroary_recombination_gvalid
      by simp
  next
    case unary_recombination
    then show ?thesis
      using pp_t_necessity_unary_recombination_gvalid
      by simp
  next
    case zeroary_exhaustion
    then show ?thesis
      using pp_t_necessity_zeroary_exhaustion_gvalid
      by simp
  next
    case unary_exhaustion
    then show ?thesis
      using pp_t_necessity_unary_exhaustion_gvalid
      by simp
  next
    case functionality
    then obtain \<sigma> \<tau> where
    ...
    show ?thesis
      unfolding A
      by (rule
        pp_t_necessity_modalized_functionality_gvalid)
  qed
qed

theorem pp_t_necessity_fragment_PP_gvalid:
  "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid_set
    pp_necessity_fragment_PP_axioms"
  unfolding
    NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid_set_def
proof (intro allI impI)
  ...
  proof cases
    case old
    show ?thesis
      using pp_t_necessity_binary_axioms_gvalid old
      unfolding
        NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid_set_def
      by blast
  next
    ...
    show ?thesis
      unfolding necessity pp_necessity_purity_axiom_def
        pp_unary_ty_def
      by (rule pp_t_necessity_operator_purity_gvalid)
  qed
qed

theorem pp_necessity_fragment_PP_axioms_consistent:
  "CEV_axiom_consistent []
    pp_necessity_fragment_PP_axioms"
  using
    NecessityFragment.MovingTreeConstants.pp_t_base_sound
    NecessityFragment.MovingTreeConstants.pp_t_zeta_sound
    pp_t_necessity_fragment_PP_gvalid
  by (rule
    NecessityFragment.MovingTreeConstants.TreeHenkin.CEV_axiom_consistent_of_gvalid)

corollary pp_necessity_fragment_consistent:
  assumes "U \<subseteq> pp_necessity_fragment_PP_axioms"
  shows "CEV_axiom_consistent [] U"
proof -
  have valid:
      "NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid_set U"
    using assms pp_t_necessity_fragment_PP_gvalid
    unfolding
      NecessityFragment.MovingTreeConstants.TreeHenkin.gvalid_set_def
    by blast
  show ?thesis
